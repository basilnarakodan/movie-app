...
import { Linking, Dimensions, Share, ScrollView, StyleSheet, Text, View, Image, TouchableOpacity, FlatList } from 'react-native';
    ...
    <ScrollView>
      ...
      <View>
        ...
        <View style={styles.castSubmenuContainer}>
          <TouchableOpacity activeOpacity={.5} onPress={()=>setIsCastSelected(true)}>
            <Text style={{...styles.castSubmenuText, color:isCastSelected?Colors.BLACK:Colors.LIGHT_GRAY}}>Cast</Text>
            </TouchableOpacity>
          <TouchableOpacity activeOpacity={.5} onPress={()=>setIsCastSelected(false)}>
